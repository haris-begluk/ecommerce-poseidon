...
// tests for CartDetailsDtoResponseData
void main() {
  // final instance = CartDetailsDtoResponseData();

  group('test CartDetailsDtoResponseData', () {
    // List<CartDetailsDto> items (default value: const [])
