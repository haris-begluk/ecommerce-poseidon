...
// tests for PaymentProviderDtoResponseData
void main() {
  // final instance = PaymentProviderDtoResponseData();

  group('test PaymentProviderDtoResponseData', () {
    // List<PaymentProviderDto> items (default value: const [])
