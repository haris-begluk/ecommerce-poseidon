...
class OfferItem extends StatelessWidget {
  ...
  void onTap(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
        builder: (_) =>
            ExploreItemDetailsSreen(item: Product(item), favorite: favorite)));
  }
            ...
            return Column(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    products.addOrRemoveProductWishList(item.productId!);
                  },
                ...
                Row(
                  ...
                  children: [
                    Text(
                      '${(item.price as double).toStringAsFixed(2)} KM',
                    ...
                    TextButton(
                      ...
                      onPressed: () {
                        cart.addItemByProduct(Product(item));
