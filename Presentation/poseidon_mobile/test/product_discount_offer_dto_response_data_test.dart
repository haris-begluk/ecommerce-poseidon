...
// tests for ProductDiscountOfferDtoResponseData
void main() {
  // final instance = ProductDiscountOfferDtoResponseData();

  group('test ProductDiscountOfferDtoResponseData', () {
    // List<ProductDiscountOfferDto> items (default value: const [])
