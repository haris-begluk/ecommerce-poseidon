...
// tests for UserProductReviewDtoResponseData
void main() {
  // final instance = UserProductReviewDtoResponseData();

  group('test UserProductReviewDtoResponseData', () {
    // List<UserProductReviewDto> items (default value: const [])
