...
// tests for WishListDetailsDtoResponseData
void main() {
  // final instance = WishListDetailsDtoResponseData();

  group('test WishListDetailsDtoResponseData', () {
    // List<WishListDetailsDto> items (default value: const [])
