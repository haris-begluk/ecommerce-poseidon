...
// tests for UserDetailsDtoResponseData
void main() {
  // final instance = UserDetailsDtoResponseData();

  group('test UserDetailsDtoResponseData', () {
    // List<UserDetailsDto> items (default value: const [])
