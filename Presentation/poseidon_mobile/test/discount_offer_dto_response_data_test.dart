...
// tests for DiscountOfferDtoResponseData
void main() {
  // final instance = DiscountOfferDtoResponseData();

  group('test DiscountOfferDtoResponseData', () {
    // List<DiscountOfferDto> items (default value: const [])
