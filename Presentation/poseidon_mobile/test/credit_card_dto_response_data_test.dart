...
// tests for CreditCardDtoResponseData
void main() {
  // final instance = CreditCardDtoResponseData();

  group('test CreditCardDtoResponseData', () {
    // List<CreditCardDto> items (default value: const [])
