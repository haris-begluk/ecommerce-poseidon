...
// tests for OrderItemDetailsDtoResponseData
void main() {
  // final instance = OrderItemDetailsDtoResponseData();

  group('test OrderItemDetailsDtoResponseData', () {
    // List<OrderItemDetailsDto> items (default value: const [])
