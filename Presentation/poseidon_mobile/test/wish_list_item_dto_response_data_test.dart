...
// tests for WishListItemDtoResponseData
void main() {
  // final instance = WishListItemDtoResponseData();

  group('test WishListItemDtoResponseData', () {
    // List<WishListItemDto> items (default value: const [])
